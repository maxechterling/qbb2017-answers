...
bedtools intersect -a ./peaks/G1E_peaks.narrowPeak -b ./peaks/ER4_peaks.narrowPeak > diff_lost.bed
## find gained peaks (G1E --> ER4)
bedtools intersect -a ./peaks/ER4_peaks.narrowPeak -b ./peaks/G1E_peaks.narrowPeak > diff_gained.bed
